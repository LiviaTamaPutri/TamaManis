            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="POST" action="?page=tsk&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">low_priority</i><label>Pilih Sifat Surat</label><br/>
                            <div class="input-field col s11 right">
                                <select class="browser-default validate" name="keterangan" id="keterangan" required>
                            ...
                            <?php
                                if(isset($_SESSION['keterangank'])){
                                    $keterangan = $_SESSION['keterangank'];
