                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE isi LIKE '%$cari%' or asal_surat LIKE '%$cari%' or no_surat LIKE '%$cari%' or no_agenda LIKE '%$cari%' ORDER by id_surat DESC LIMIT 15");
