                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar WHERE isi LIKE '%$cari%' or tujuan LIKE '%$cari%' or no_surat LIKE '%$cari%' or no_agenda LIKE '%$cari%' ORDER by id_surat DESC LIMIT $curr, 15");
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    while($row = mysqli_fetch_array($query)){
                                      ...
                                      <tr>
                                        <td>'.$row['no_agenda'].'</td>
                                        <td>'.substr($row['isi'],0,200).'<br/><hr/><strong>File :</strong>';
